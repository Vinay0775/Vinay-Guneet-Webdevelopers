const portfolioConfig = {
  ...
  socials: {
    ...
    whatsapp: "https://wa.me/918058930127",
  },
};
...
const translations = {
  "meta.title": {
    en: "Vinay & Guneet | Premium Web Developer Portfolio",
    hi: "विनय विश्वकर्मा | प्रीमियम वेब डेवलपर पोर्टफोलियो",
  },
  "meta.description": {
    en: "Vinay and Guneet are web developers crafting fast, scalable, and visually polished digital experiences.",
...
function updateAccessibilityText() {
  ...
  if (brand) {
    brand.setAttribute(
      "aria-label",
      currentLanguage === "hi" ? "विनय और गुनीत होम" : "Vinay & Guneet home"
    );
  }
